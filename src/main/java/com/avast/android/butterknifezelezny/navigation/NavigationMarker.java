...
class NavigationMarker extends LineMarkerInfo<PsiElement> {
    ...
    private static final Icon ICON = IconLoader.getIcon("/icons/butterknife-zelezny.png", null);
    ...
    private NavigationMarker(@NotNull final PsiElement source, @NotNull final PsiMember destination,
        ...
        super(source, textRange, ICON, null, new DefaultGutterIconNavigationHandler<PsiElement>(Lists.newArrayList(destination), ""), LEFT, null);
